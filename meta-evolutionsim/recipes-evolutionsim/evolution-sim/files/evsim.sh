...
# Default-Stop:		 0
# Short-Description: Init script to start running the evolution simulation main program
# Description:       Starts/Stops the evolution simulation program. This was basically copied
#					 from the `skeleton` example distributed with poky
### END INIT INFO
